(()=>{"use strict";
const DB="sps-lager-db",STORE="articles";let db,scanner=null,current=null,pendingCode="";
...
$("scanBtn").onclick=startScan;$("manualBtn").onclick=()=>{const c=prompt("Barcode oder Artikelcode eingeben:");if(c)handle(c)};$("listBtn").onclick=async()=>{await render();show("inventory")};$("stopScan").onclick=async()=>{await stop();show("home")};
